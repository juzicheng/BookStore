<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\IDE\xampp\htdocs\BookHouse\public/../application/index\view\index\created.html";i:1515854796;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="card main_body center-block">
    ...
    <div class="row">
        <div class="col-xs-10 col-xs-offset-1 col-sm-4 col-sm-offset-0">
            <img src="<?php echo $DIR_IMG; ?>/bcover.jpg" alt="..." class="img-thumbnail" style="margin: 10px;">
        </div>
